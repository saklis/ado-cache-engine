...
ADO Cache Engine is an ORM (Object-relational mapping) tool build around the idea of caching all the required data in RAM memory of the host to decrease data access times.
